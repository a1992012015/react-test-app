...
export class EvaluatePoint {
  ...
  scorePoint = (data: IScorePoint): number => {
    ...
    if (dir === undefined || dir === 0) {
      ...
      this.scoreCache[role][0][y][x] = this.calculateScore(leftRoles, rightRoles, role);
    }
    ...
    if (dir === undefined || dir === 1) {
      ...
      this.scoreCache[role][1][y][x] = this.calculateScore(leftRoles, rightRoles, role);
    }
    ...
    if (dir === undefined || dir === 2) {
      ...
      this.scoreCache[role][2][y][x] = this.calculateScore(leftRoles, rightRoles, role);
    }
    ...
    if (dir === undefined || dir === 3) {
      ...
      this.scoreCache[role][3][y][x] = this.calculateScore(leftRoles, rightRoles, role);
    }
